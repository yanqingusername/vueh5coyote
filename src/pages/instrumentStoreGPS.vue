<template>
  <div class="child-section">
    ...
    <div class="bind_main">
      <div class="bind_main_item">
        ...
        <div class="drop-select-item">
          <DropDownList
              ...
              placeholder="请选择仪器类型"
            />
            <!-- <div class="drop_select_text">请选择仪器类型</div>
            <img class="drop_select_arrow" src="../assets/images/icon_arrow_gray.png" alt="" />

            <div class="drop_select_dialog_bg"  v-if="isShowInstrument">
              <div class="drop_select_dialog"
              v-for="(item, index) in instrumentLists"
              :key="index"
              @click="selectInstrument"
              :data-instrumentname="item.instrument_name"
              :data-index="index">
              <div @click="selectInstrument"
              :data-instrumentname="item.instrument_name"
              :data-index="index">{{item.instrument_name}}</div>
                  <img v-if="instrumentIndex == index" style="width:20px;height:20px;" src="../assets/images/icon_selected.png" alt="" />
              </div>
            </div> -->
        </div>
      ...
      <div class="bind_main_item">
        <div class="icon_login_text">GPS信息</div>
        <div class="form-item">
          <div class="select-item input-item">
            <input
              v-model="label_sn"
      ...
      <div class="bind_main_item">
        ...
        <div class="form-item" style="border-bottom: none;">
          ...
          <!-- <div class="img_1_view">
            <img class="img_1" v-if="imgurl1" :src="imgurl1" alt="" @click="ImagePreview" :data-img="imgurl1"/>
            <div class="img_1" v-else></div>
            <div class="img_1_text">GPS编号</div>
          </div> -->
          <div class="img_1_view">
        ...
        <div class="form-item" style="border-bottom: none;padding-left: 6px;">
          ...
          <div class="img_1_view">
            <div class="img_1_bg"></div>
            <div class="img_1_text_bg"></div>
          </div>
...
import { udateH5Images,uploadImgSelect,uploadImgBind ,bindinstrument, getJSSDKHELP,saveinstrument,getModule} from "../request/api";
// import { Notify } from "vant";
import { Button,Dialog ,Uploader,Toast,ImagePreview,Loading,DropdownMenu, DropdownItem} from 'vant';
